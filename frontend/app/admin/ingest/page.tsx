...
import ingestionImg from "@/public/ingestion.svg"
...
export default function IngestPage() {
    ...
    return (
        <div className="flex flex-col lg:flex-row-reverse items-start gap-10 lg:gap-16 xl:gap-24 w-full">

            {/* Illustration Section (Hidden on mobile, sticky on desktop) */}
            <div className="hidden lg:flex w-full max-w-md xl:max-w-lg sticky top-28 animate-in fade-in slide-in-from-right-8 duration-700">
                <Image
                    alt="Data Ingestion Process Illustration"
                    src={ingestionImg}
                    className="w-full h-auto drop-shadow-xl dark:opacity-85 transition-opacity"
                    priority
                />
            </div>
                ...
                <Card className="animate-fade-up border-border/60 shadow-sm bg-card/80 backdrop-blur-sm">
                    ...
                    <CardContent className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex gap-4 sm:gap-6 items-start sm:items-center flex-col sm:flex-row">
                                <label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground pt-1">Symbols</label>

                                <div className="inline-flex bg-muted/50 p-1 rounded-lg border border-border/50">
                                    <button
                                        onClick={() => setUseCustom(false)}
                                        className={cn(
                                            "flex items-center gap-2 rounded-md px-3 py-1 text-sm font-semibold transition-all cursor-pointer",
                            ...
                            {useCustom ? (
                                <div className="flex flex-col gap-0.5 animate-in fade-in slide-in-from-top-1">
                                    <Input
                            ...
                            <div className="inline-flex bg-muted/50 p-1 rounded-lg border border-border/50">
                                {(["sync", "background"] as const).map((m) => (
                                    <button
                                        ...
                                        onClick={() => setMode(m)}
                                        className={cn(
                                            "flex items-center gap-2 rounded-md px-3 py-1 text-sm font-semibold transition-all capitalize cursor-pointer",
